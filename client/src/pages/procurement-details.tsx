    ...
    >
      ...
      <Box mt="20px" display="flex" flexDirection={{ xs: 'column', lg: 'row' }} gap={4}>
        ...
        <Box flex={1} maxWidth={764}>
          <img
            src={procurementDetails.photo}
            alt="procurement_details-img"
            height={546}
            style={{ objectFit: 'cover', borderRadius: '10px' }}
            className="procurement_details-img"
          />

          <Box mt="15px">
            <Stack direction="row" justifyContent="space-between" flexWrap="wrap" alignItems="center">
              <Typography fontSize={18} fontWeight={500} color="#11142D" textTransform="capitalize">{procurementDetails.procurementType}</Typography>
              <Box>
            ...
            <Stack direction="row" flexWrap="wrap" justifyContent="space-between" alignItems="center" gap={2}>
              <Box>
                <Typography fontSize={22} fontWeight={600} mt="10px" color="#11142D">{procurementDetails.title}</Typography>
                <Stack mt={0.5} direction="row" alignItems="center" gap={0.5}>
                  <Place sx={{ color: '#808191' }} />
                  <Typography fontSize={14} color="#808191">{procurementDetails.location}</Typography>
                </Stack>
              </Box>
              ...
              <Box>
                ...
                <Stack direction="row" alignItems="flex-end" gap={1}>
                  <Typography fontSize={25} fontWeight={700} color="#475BE8">${procurementDetails.price}</Typography>
        ...
        <Box width="100%" flex={1} maxWidth={326} display="flex" flexDirection="column" gap="20px">
          ...
          >
            ...
            <Stack mt={2} justifyContent="center" alignItems="center" textAlign="center">
              ...
              <Box mt="15px">
                <Typography fontSize={18} fontWeight={600} color="#11142D">{procurementDetails.creator.name}</Typography>
              ...
              <Typography mt={1} fontSize={16} fontWeight={600} color="#11142D">{procurementDetails.creator.allProcurements.length} Procurements</Typography>
            </Stack>
            ...
            <Stack width="100%" mt="25px" direction="row" flexWrap="wrap" gap={2}>
              <CustomButton
                ...
                handleClick={() => {
                  if (isCurrentUser) {
                    navigate(`/procurements/edit/${procurementDetails._id}`);
                  }
                }}
              />
              <CustomButton
                ...
                handleClick={() => {
                  if (isCurrentUser) handleDeleteProcurement();
                }}
              />
            </Stack>
          </Stack>
